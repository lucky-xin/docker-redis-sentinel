...
{
  echo "QUORUM=2"
  echo "DOWN_AFTER=30000"
  echo "FAILOVER_TIMEOUT=180000"
  echo "PARALLEL_SYNCS=1"
  echo "REDIS_PWD=$REDIS_PWD"
  echo "REDIS_MASTER_AUTH=$REDIS_PWD"
  echo "REDIS_AUTH_PASS=$REDIS_PWD"
} > $PWD/.env
